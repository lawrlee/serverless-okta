      ...
      <div>
        <Menu fixed="top" inverted>
          <Container>
            ...
            {<Menu.Item id="messages-button" as="a" href="/cats">Cats</Menu.Item>}
            {this.state.authenticated === true && <Menu.Item id="messages-button" as="a" href="/pangolins">Pangolins</Menu.Item>}
